...
#'
#' @param cdms_host URL for CDMS website. The default is the Nez Perce Tribe's data repository \url{https://cdms.nptfisheries.org}.
#'
#' @return \code{get_JuvenileEstimates()} returns a dataframe
#'   with all lifestage abundance, survival and smolt equivalent (smoltEq)
#'   estimates stored in \url{https://cdms.nptfisheries.org} for each juvenile
#'   screw trap, seining and hatchery release group.
#'
#' @export
#'
#' @import dplyr
